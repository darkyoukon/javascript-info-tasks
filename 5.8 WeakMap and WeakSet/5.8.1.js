"use strict";
console.log('The first task: Store "unread" flags');
...
let weakReadConfirmation = new WeakSet();

weakReadConfirmation.add(messages[2]);

console.log("You have the next unread messages: ");
for (let message of messages) {
  if (weakReadConfirmation.has(message)) continue;
